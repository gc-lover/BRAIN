...
**api-readiness-notes:** Документ описывает организационную структуру .BRAIN и не формирует API задачи; статус not-applicable подтверждён 2025-11-09 03:48.
...
### 3. Метаданные
- Используй компактную шапку: статус, приоритет, `api-readiness`, `api-readiness-notes`
- История изменений отслеживается в Git
...
**api-readiness-notes:** Ключевые замечания по готовности (опционально)
