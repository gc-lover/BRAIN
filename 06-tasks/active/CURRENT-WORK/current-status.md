...
**Последнее обновление:** 2025-11-03 20:15
...
**Итого готовых к API:** 35 документов
...
**Итого требует доработки:** 6 документов (3 лор + 4 служебных)

---

## 📊 Статистика готовности к API

- **Готово к API (ready):** 35 документов
- **Требуют доработки (needs-work):** 3 документа с механиками (лор)
- **Не применимо (not-applicable):** Обзорные документы, концептуальные документы, служебные файлы
- **В проверке (review):** 0 документов

**Процент готовности игровых механик к API:** ~92% (35 готовых из 38 документов с механиками)
