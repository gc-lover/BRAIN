...
## Active
- Combat Systems Wave 1 — документы по combat-session, combat-ai-enemies, combat-implants-types, combat-dnd-core, combat-dnd-integration-shooter, combat-abilities, combat-shooting, combat-combos-synergies, combat-extract, combat-freerun, combat-hacking-networks, combat-hacking-combat-integration, combat-cyberspace и arena-system имеют статус ready; перепроверены 2025-11-09 01:39 (ai, dnd-core, dnd-integration, abilities, shooting, stealth, freerun, hacking, combos, arena) и выровнены каталоги `api/v1/gameplay/combat/*.yaml`; готовим единый пакет (`current note: 2025-11-09-combat-ai-package.md`, `2025-11-09-combat-wave-package.md`, `2025-11-09-combat-shooting-package.md`, `2025-11-09-combat-stealth-package.md`) для передачи в ДУАПИТАСК.
