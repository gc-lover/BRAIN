...
- Quest Branching PoC — документ `2025-11-09-quest-branching-poc-plan.md` + скрипты в `scripts/poc/quest-branching/` (README, run_poc.ps1, SQL); следующий шаг — реальный прогон миграций и сбор результатов.
## Pending
