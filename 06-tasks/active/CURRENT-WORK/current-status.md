...
- Quest Branching PoC — документ `2025-11-09-quest-branching-poc-plan.md` фиксирует последовательность `update → проверки → rollback`, метрики и требования к отчёту; следующий шаг — реальный прогон миграций и сбор результатов.
## Pending
