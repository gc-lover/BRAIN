...
**Последнее обновление:** 2025-11-03 20:05
...
**Итого готовых к API:** 34 документа
...
**Итого требует доработки:** 8 документов (4 лор + 4 служебных)

---

## 📊 Статистика готовности к API

- **Готово к API (ready):** 34 документа
- **Требуют доработки (needs-work):** 4 документа с механиками (лор)
- **Не применимо (not-applicable):** Обзорные документы, концептуальные документы, служебные файлы
- **В проверке (review):** 0 документов

**Процент готовности игровых механик к API:** ~89% (34 готовых из 38 документов с механиками)
