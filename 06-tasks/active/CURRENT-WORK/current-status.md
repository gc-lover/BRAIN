...
## Active
- Combat Systems Wave 1 — документы по combat-session, combat-ai-enemies, combat-implants-types, combat-dnd-core, combat-dnd-integration-shooter, combat-abilities, combat-shooting, combat-combos-synergies, combat-extract, combat-freerun, combat-hacking-networks, combat-hacking-combat-integration, combat-cyberspace и arena-system имеют статус ready; перепроверены 2025-11-09 01:13 (abilities, dnd-core, stealth, freerun); готовим единый пакет (`current note: 2025-11-09-combat-ai-package.md`, `2025-11-09-combat-wave-package.md`) для передачи в ДУАПИТАСК; обновлены ссылки на целевые каталоги в `ready.md` и `readiness-tracker.yaml` (AI, arena, D&D, stealth, freerun).
