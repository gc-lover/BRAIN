...
**Последнее обновление:** 2025-11-03 20:30
...
**Итого готовых к API:** 37 документов
...
**Итого требует доработки:** 4 документа (1 лор + 4 служебных)

---

## 📊 Статистика готовности к API

- **Готово к API (ready):** 37 документов
- **Требуют доработки (needs-work):** 1 документ с механиками (лор)
- **Не применимо (not-applicable):** Обзорные документы, концептуальные документы, служебные файлы
- **В проверке (review):** 0 документов

**Процент готовности игровых механик к API:** ~97% (37 готовых из 38 документов с механиками)
