...
**Последнее обновление:** 2025-11-03 20:25
...
**Итого готовых к API:** 36 документов
...
**Итого требует доработки:** 5 документов (2 лор + 4 служебных)

---

## 📊 Статистика готовности к API

- **Готово к API (ready):** 36 документов
- **Требуют доработки (needs-work):** 2 документа с механиками (лор)
- **Не применимо (not-applicable):** Обзорные документы, концептуальные документы, служебные файлы
- **В проверке (review):** 0 документов

**Процент готовности игровых механик к API:** ~95% (36 готовых из 38 документов с механиками)
