...
1. **Liquibase миграции**
   - [~] Сформировать changelog `quest-branching-v1` — готово `master.xml`, `v1/01-create-core-tables.xml`, `v1/02-create-branching-tables.xml`; осталось `03+` (world state, индексы, shadow-write, MV, RLS).
