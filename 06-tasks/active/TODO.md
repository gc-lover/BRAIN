...
- [ ] Combat Abilities — подготовить brief по `.BRAIN/02-gameplay/combat/combat-abilities.md` (источники, ранги, ограничения) для ДУАПИТАСК (2025-11-09 01:05).
- [ ] Combat D&D Core — зафиксировать требования по `.BRAIN/02-gameplay/combat/combat-dnd-core.md` и согласовать структуру API (`api/v1/gameplay/combat/dnd-core.yaml`) (2025-11-09 01:05).
- [ ] Combat Freerun — подготовить brief по `.BRAIN/02-gameplay/combat/combat-freerun.md` (паркур, боевые манёвры) для ДУАПИТАСК (2025-11-09 01:05).
## Low
- *(пусто)*
