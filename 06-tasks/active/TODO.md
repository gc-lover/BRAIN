...
## High
- [~] Quest Branching Liquibase — подготовить полный набор changeSet (world-state, shadow-write, RLS, MV) и прогнать PoC миграций по плану `2025-11-09-quest-branching-liquibase-plan.md`.
