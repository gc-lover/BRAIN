# Фракционные мировые квесты

Квесты для конкретных фракций в разных странах мира.
...
- [Maelstrom](./maelstrom-world-quests.md) — 6 квестов
- [Tyger Claws](./tyger-claws-world-quests.md) — 6 квестов

### Номады
- [Aldecaldos](./aldecaldos-world-quests.md) — 8 квестов
- [Nomad Clans](./nomad-clans-world-quests.md) — 6 квестов

### Другие
- [Voodoo Boys](./voodoo-boys-world-quests.md) — 6 квестов
- [Fixers Network](./fixers-world-quests.md) — 8 квестов

## Механика

- Квесты доступны только при достижении репутации с фракцией
- Выполнение квестов повышает репутацию
- Квесты связаны с интересами фракции в разных регионах
