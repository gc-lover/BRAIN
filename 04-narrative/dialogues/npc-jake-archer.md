...
**Последнее обновление:** 2025-11-07 20:24  
**Приоритет:** высокий  
...
**api-readiness:** ready  
**api-readiness-check-date:** 2025-11-07 20:24  
...
GraphQL поле `traderDialogue(id: ID!)` возвращает `TraderDialogueNode` с `economyHooks` для передачи скидок в economy-service.
