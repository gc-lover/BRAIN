...
**✅ Решение:** Гибридная система с перезапуском каждой лиги
...
## D&D/MMORPG проверки и групповые правила

- Броски d20 с модификаторами атрибутов/навыков против DC (см. `quest-dnd-checks.md` и `combat-dnd-core.md`).
- Преимущество/Помеха (2d20 лучший/худший) от имплантов, укрытий, состояний.
- Групповые проверки: ассистенты дают +1 к ведущему (макс +3) или успех по большинству.
- История бросков логируется для кооп/честности.
- Диапазоны DC подстраиваются под фракцию/зону/уровень контента.

Связанные:
- `04-narrative/quests/main/README.md` — индекс узлов
- `04-narrative/quest-dnd-checks.md`
