...
**api-readiness-notes:** Документ содержит детальные решения по системе перков (структура, получение, ограничения, комбинации) (v1.0.0). Готов к проверке на готовность к API разработке.
