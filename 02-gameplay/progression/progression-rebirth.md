...
**api-readiness-notes:** Документ содержит детальные решения по системе перерождений (механика, типы, преимущества, ограничения) (v1.0.0). Готов к проверке на готовность к API разработке.
