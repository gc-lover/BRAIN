...
**api-readiness-notes:** Перепроверено 2025-11-09 02:47. Типы лута, рисковые уровни, страховка/восстановление и эвакуационные события готовы для формирования пакета API задач (v1.3.0).
