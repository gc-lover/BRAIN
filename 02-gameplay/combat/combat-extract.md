...
**api-readiness-check-date:** 2025-11-03 19:09  
**api-readiness-notes:** Документ содержит детальные решения по типам лута, редкости, источникам, влиянию сложности зоны, времени в зоне и динамической сложности (v1.3.0). TODO только для страховки/восстановления (не блокирует API). Готов к проверке на готовность к API разработке.
