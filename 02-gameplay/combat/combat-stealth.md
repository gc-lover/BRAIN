...
**api-readiness-notes:** Документ содержит детальные решения по системе обнаружения (каналы, профили врагов, импланты, сети) (v1.1.0). TODO только для балансировки (не блокирует API). Готов к проверке на готовность к API разработке.
