...
**api-readiness-notes:** Перепроверено 2025-11-09 01:22. Документ фиксирует каналы обнаружения, импланты, социальную инженерию; балансировочные TODO не блокируют создание задач.
