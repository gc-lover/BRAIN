...
**api-readiness-notes:** Полная спецификация арен: режимы, карты, рейтинги, награды, интеграции с лидербордами и голосовыми лобби; перепроверено 2025-11-09 00:55 перед постановкой API задач.
---
