...
**api-readiness-notes:** Перепроверено 2025-11-09 02:50. Паркур и боевые манёвры (атаки с воздуха, стрельба в движении, импланты, мобильные комбо) готовы к постановке API задач (v1.1.0); балансные TODO не блокируют.
