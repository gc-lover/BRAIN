...
**api-readiness-notes:** Документ содержит детальные решения по интеграции паркура с боем (атаки с воздуха, стрельба в движении, мобильные способности, комбо) (v1.1.0). TODO только для балансировки (не блокирует API). Готов к проверке на готовность к API разработке.
