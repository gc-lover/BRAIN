...
**api-readiness:** ready  
**api-readiness-check-date:** 2025-11-09 01:09
**api-readiness-notes:** Перепроверено 2025-11-09 01:09. Документ готов к API: интеграция паркура с боем (атаки с воздуха, стрельба в движении, мобильные способности, комбо) (v1.1.0). Балансные TODO не блокируют задачи.
