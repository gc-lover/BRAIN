...
**api-readiness-notes:** Перепроверено 2025-11-09 01:13. Документ готов к API: интеграция паркура с боем (атаки с воздуха, стрельба в движении, мобильные способности, комбо) (v1.1.0). Балансные TODO не блокируют задачи.
