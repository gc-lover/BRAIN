...
**api-readiness-notes:** Перепроверено 2025-11-09 01:15. D&D система проверок (d20/d100, DC, модификаторы, критические случаи, атрибуты, навыки, преимущества/помехи) готова для API задач.
