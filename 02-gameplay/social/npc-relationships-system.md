...
**api-readiness-notes:** Первый брейншторм - полная система отношений с NPC
...
4. Как работает система наставничества? (Teacher класс и NPC)
5. Как работает система семейных отношений?
6. Как работает система найма NPC?
7. Как работают заказы от игроков через NPC?
