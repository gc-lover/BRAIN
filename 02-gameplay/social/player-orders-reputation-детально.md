...
- **Tasks:**
  ...
  - API-TASK-339 — `api/v1/economy/player-orders/risk.yaml` (страхование, escrow и скоринг рисков вознаграждений) — in_progress, взято API Executor 2025-11-08 18:40.
