...
- **Tasks:**
  ...
  - API-TASK-338 — `api/v1/social/player-orders/reviews.yaml` (создание и модерация отзывов, выборки для UI, жалобы/флаги) — in_progress, взято API Executor 2025-11-08 18:15.
