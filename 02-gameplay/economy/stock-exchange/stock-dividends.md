...
- v1.0.0 (2025-11-06 21:45) - Создание документа о дивидендах
  - Определены типы дивидендов (quarterly, annual, fixed, variable)
  - Описан расчет дивидендов (formula)
  - Описаны важные даты (ex-dividend, payment)
