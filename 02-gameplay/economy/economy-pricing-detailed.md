...
**api-readiness:** ready  
**api-readiness-check-date:** 2025-11-09 03:52  
**api-readiness-notes:** Перепроверено 2025-11-09 03:52. Формулы ценообразования, коэффициенты редкости, качества, спроса/предложения, региональные и фракционные модификаторы описаны детально; документ готов к пакетированию задач economy-service.
