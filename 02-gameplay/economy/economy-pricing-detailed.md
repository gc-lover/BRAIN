...
**api-readiness-notes:** Перепроверено 2025-11-09 04:00. Формулы ценообразования, коэффициенты редкости, качества, спроса/предложения, региональные и фракционные модификаторы описаны детально; документ готов к пакетированию задач economy-service.
