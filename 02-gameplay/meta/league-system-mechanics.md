...
**api-readiness:** ready  
**api-readiness-check-date:** 2025-11-06 18:50
**api-readiness-notes:** Система лиг полностью определена (цикл, сброс, мета-прогресс, награды, рейтинги). Готово для создания API задач.
