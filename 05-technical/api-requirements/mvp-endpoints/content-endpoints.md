...
**Endpoints распределены по сервисам:**
- `/api/v1/gameplay/quests/*` → gameplay-service (8083) 📋
- `/api/v1/social/npcs/*` → social-service (8084) 📋
- `/api/v1/gameplay/combat/*` → gameplay-service (8083) 📋
- `/api/v1/economy/trading/*` → economy-service (8085) 📋

**Доступ:** Все через API Gateway (http://localhost:8080)
