...
- Экран входа/регистрации (детали регистрации в [ui-registration.md](./ui-registration.md))
...
**Примечание:** Детальное описание экрана регистрации находится в отдельном документе [ui-registration.md](./ui-registration.md).
...
**Детальное описание:** См. [ui-registration.md](./ui-registration.md)

**Краткое описание:**
- Поле для ввода email (обязательно)
- Поле для ввода логина (обязательно, уникальность)
- Поле для ввода пароля (обязательно, минимум 8 символов)
