...
Response:
{
  ...
  "categories": ["COMBAT", "QUEST", "SOCIAL", ...]
}
```

**GET `/api/v1/players/{id}/achievements`** - прогресс игрока
...
**GET `/api/v1/achievements/leaderboard`** - таблица лидеров
...
- [Achievement UI](../../ui/achievements/achievement-ui.md)
