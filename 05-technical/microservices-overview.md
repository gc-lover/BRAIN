...
Детальное описание микросервисной архитектуры backend систем NECPGAME. Документ описывает инфраструктуру, микросервисы, их взаимодействие, deployment и миграцию с монолита.

---

## Статус миграции

**Текущий этап:** Фаза 1 (Infrastructure + Auth Service) - ✅ Завершена

**Hybrid подход:**
- ✅ Монолит работает (все 107 endpoints)
- ✅ Микросервисы работают параллельно (auth-service)
