...
## 3. D&D-параметры
- Инициатива: d20 + REF (в физ. встречах), «инициатива сетей» для нетрана.
- AC противников: 15–17; ICE/guardian: 18–19.
- Крит: 20 — крит-скрипт; 1 — обратный удар (recoil).
- Состояния: «Кибершок», «Перегрев», «Подавление».
