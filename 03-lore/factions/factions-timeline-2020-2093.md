...
**Последнее обновление:** 2025-11-07 21:46  
**Приоритет:** high  
**api-readiness:** ready  
**api-readiness-check-date:** 2025-11-07 21:46  
**api-readiness-notes:** Хронология авторских фракций 2020-2093: лор, ключевые события, механики и API-контуры для world-service/social-service.
---
